...
from authz.permissions import HasAdminPermission, HasOperatorPermission
from wolontariat_obsluga.models import Message
from wolontariat_obsluga.serializers import MessageSerializer
